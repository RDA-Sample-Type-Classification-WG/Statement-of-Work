...
particular scientific domain, but none that would be domain agnostic,
i.e.\ generally applicable to all physical objects being investigated
...
\item A Common Data Dictionary and Common Data Model for Additive
  Manufacturing\footnote{Kuan, A., Aggour, K.S., Li, S., Lu, Y., Mohr,
    L., Kitt , A., Macdonald, H.  A Common Data Dictionary and Common
    Data Model for Additive Manufacturing.  Integr Mater Manuf Innov
    13, 105–119 (2024).
    \url{https://doi.org/10.1007/s40192-024-00341-x}}
\item The CIDOC Conceptual Reference Model (CRM,
